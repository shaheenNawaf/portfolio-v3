...
A full end-to-end booking and management application built for a computer service and repair shop. Features customer-facing maintenance booking, serialized inventory tracking with stock in/out monitoring, and automated HR functionality covering payroll, leave, and absence management.
